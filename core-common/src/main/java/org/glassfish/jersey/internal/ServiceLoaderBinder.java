...
/**
 * Simple {@link ServiceLoader} injection binder.
 *
 ...
 */
public class ServiceLoaderBinder<T> extends AbstractBinder {
     ...
     */
    public ServiceLoaderBinder(Class<T> contract, Map<String, Object> applicationProperties, RuntimeType runtimeType) {
        this.contract = contract;
        this.applicationProperties = applicationProperties;
        this.runtimeType = runtimeType;

        ServiceLoaderBinder.class.getModule().addUses(contract);
    }
